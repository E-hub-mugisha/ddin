    ...
    <div class="container">
        ...
        <div class="row align-items-center">
                <div class="position-relative wow animated fadeInLeft">
                    <div class="label text-success bg-light-success d-inline-flex rounded-4 mb-2 font--medium"><span>Our Areas</span></div>
                    <h2 class="fs-1 mb-3 mb-lg-3 lh-base">Local Agents Everywhere <span style="color: #F8882B;">Across Rwanda</span></h2>
